      ...
      <div className="p-4 border-b border-gray-200">
        <div className="flex justify-center">
          <div className="text-center">
            <img src="/logo.png" alt="Paşa Home" className="h-10 mx-auto" />
            <h2 className="mt-2 text-sm font-medium text-gray-600">Paşa Home</h2>
          </div>
        </div>
      </div>
      <nav className="flex-1 p-2 space-y-1">
        {navigation.map((item) => {
          if (item.name === 'Ürünler') {
            const isActive = pathname.startsWith('/dashboard/urunler/liste');
            return (
              <div key={item.name}>
                <button
